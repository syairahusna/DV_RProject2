...
In the graph below, 0 = Not Identified, 1 = Male, 2 = F, 3 = Other
The plot shows that overall narcissim decreases slightly with age, regardless of gender. The negative correlation shows narcissistic tendencies are frequent with lower age.
